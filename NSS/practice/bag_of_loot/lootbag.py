...
class LootBag:
    ...
    def write_toy_to_file(self, toy_name, child_id, action):
        with open('toylist', 'a') as toys:
            toy_id = uuid.uuid4()
            toys.write('{},{}\n'.format(toy_id, toy_name, child_id))

    def add_to_bag(self, toy, child_name):
        """Add a toy and assign it to a child. Both the toy and the child will be written to disk in the 'toylist' or 'children' file, respectively.
